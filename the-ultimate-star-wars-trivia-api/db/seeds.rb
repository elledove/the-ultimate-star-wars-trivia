...
Question.create(name: "In which movie does Princess Lea say these iconic lines?", theme: films)
Question.create(name: "What planet was Anakin discovered on?", theme: planets)
Question.create(name: "What is is the name of Han Solos ship?", theme: spaceships)    
